...
Input:   The input is the name of a text file typed in from the keyboard, contains text of <= 200 lines of <= 60 chars
...
char textArray[199][60];														// char array to store line in
